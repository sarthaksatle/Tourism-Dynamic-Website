...
<div class='divbacktheme'>
    <div  class='innerdivtheme'>
        <form action="UserChangePasswordcode.jsp">
        <table  align='center' border='0' cellspacing='10' cellpadding='5'  class='logintheme'>
            ...
            <tr>
                <td><input type='password' name='newpassword'  class='texttheme'></td>
            </tr>
            ...
            <tr>
                <td><input type='password' name='confirmpassword'  class='texttheme'></td>
            </tr>
            
            <tr align='center'>
                <td>
                    <input type='submit' value="Change Password" class='btntheme'>
                </td>
            </tr>
